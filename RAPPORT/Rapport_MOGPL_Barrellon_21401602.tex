...
En effet, le solveur annonce "\texttt{Model is infeasible}" et plante pour certaines configurations (N,M,P). 

En effet, on doit avoir $M > \frac{2P}{M} \Leftrightarrow P < \frac{M^2}{2}$ et $N > \frac{2P}{N} \Leftrightarrow P < \frac{N^2}{2}$. \\
J'ai intégré ces condition dans le programme Python, en restreignant les choix possibles de l'utilisateur. 
