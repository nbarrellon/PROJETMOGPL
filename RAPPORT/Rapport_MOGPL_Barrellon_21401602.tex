...
On ontient ainsi un graphe d'étude G(V,E) avec :
\begin{itemize}
...
\item chaque état possède au mieux 2 arêtes (pour "tourner" d'une orientation à l'autre) et 3 arêtes (pour avancer si possible vers un autre sommet) soir $|E| = 7(NM-4\ times P)$.
\end{itemize}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.5]{instanceX-X-X.png}
